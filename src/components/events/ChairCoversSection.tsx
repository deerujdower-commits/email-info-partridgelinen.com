...
import chairCoverWhite from '@/assets/partridge-linen-events-chair-cover-white.webp';
import chairCoverBlack from '@/assets/partridge-linen-events-chair-cover-black.webp';
import chairSashExample from '@/assets/partridge-linen-events-chair-sash-example.webp';
      ...
      <div className="bg-muted/30 border border-border rounded-lg p-5 h-full transition-all duration-300 hover:shadow-lg hover:border-primary/20 hover:bg-muted/40">
        <div className="flex flex-col sm:flex-row gap-5">
          ...
          <div className="flex-1 min-w-0 order-2 sm:order-1 text-center sm:text-left">
            <h3 className="font-display text-lg font-medium text-foreground mb-1 hidden sm:block">Chair Covers</h3>
            <p className="text-xs text-foreground/60 font-body mb-4 hidden sm:block">3 Day Hire</p>
            ...
            <div className="mb-4">
              <p className="text-sm font-body text-foreground/70">
                Price: <span className="text-foreground font-medium">£1.20 each inc. VAT</span>
              </p>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center gap-3 justify-center sm:justify-start">
                <Button
                  ...
                  size="icon"
                  className="h-9 w-9"
                  onClick={() => setChairQuantity(Math.max(0, chairQuantity - 1))}
                >
        ...
        <div className="border-t border-border pt-5 mt-5">
          <div className="flex flex-col sm:flex-row gap-5">
            ...
            <div className="flex-1 min-w-0 order-2 sm:order-1">
              <h4 className="font-display text-lg font-medium text-foreground mb-1 hidden sm:block">Chair Cover Sashes</h4>
              <p className="text-xs text-foreground/60 font-body mb-4 hidden sm:block">3 Day Hire</p>

              {/* Price Display */}
              <div className="mb-4">
                <p className="text-sm font-body text-foreground/70">
                  Price: <span className="text-foreground font-medium">70p each inc. VAT</span>
                </p>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-3">
                  <Button
                    ...
                    size="icon"
                    className="h-9 w-9"
                    onClick={() => setSashQuantity(Math.max(0, sashQuantity - 1))}
                  >
                    <Minus className="w-4 h-4" />
                  </Button>
                  ...
                  <Button
                    ...
                    size="icon"
                    className="h-9 w-9"
                    onClick={() => setSashQuantity(sashQuantity + 1)}
                  >
                    <Plus className="w-4 h-4" />
                  </Button>
                </div>
