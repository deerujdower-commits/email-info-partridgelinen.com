...
const stats = [
  { number: '50000000', label: 'Garments Cleaned', suffix: 'M+', displaySuffix: 'M+' },
  { number: '30', label: 'Years Established', suffix: 'years', displaySuffix: '+' },
  { number: '1000', label: 'Happy Customers', suffix: 'count', displaySuffix: '+' }
];
...
const StatsSection = () => {
  ...
  const formatNumber = (num: number, suffix: string) => {
    ...
    } else if (suffix === 'years' || suffix === 'count') {
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="font-display text-4xl md:text-6xl font-light mb-2 leading-tight">
                ...
                <span className="text-2xl md:text-3xl">{stat.displaySuffix}</span>
              </div>
