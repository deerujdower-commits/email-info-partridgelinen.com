      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 md:grid md:grid-cols-2 md:gap-x-4 md:gap-y-2 md:space-y-0 lg:block lg:space-y-2">
          ...
          <div className="md:col-span-2 lg:col-span-3 grid sm:grid-cols-2 gap-6">
            <div>
              ...
              <a 
                href="https://www.google.com/maps/search/?api=1&query=1-5+The+Drive,+Thornton+Heath,+CR7+8LB,+UK" 
                target="_blank" 
                rel="noopener noreferrer"
                className="font-body text-sm text-muted-foreground flex items-start gap-2 hover:text-accent transition-colors"
              >
