            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <a 
                  ...
                  className="text-white font-body leading-relaxed hover:text-white/80 transition-colors underline-offset-2 hover:underline"
                >
                  1-5 The Drive, Thornton Heath CR7 8LB
                </a>
              </div>
            </div>
