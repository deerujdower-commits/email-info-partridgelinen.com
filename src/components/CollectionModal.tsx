...
const CollectionModal = ({ isOpen, onClose, category, fromEventsPage = false }: CollectionModalProps) => {
  ...
  // No auto-carousel - manual navigation only for better performance
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 lg:p-6 border-b border-border flex-shrink-0">
          <div>
            <h2 className="text-xl lg:text-2xl font-display text-foreground">{category.title}</h2>
            <p className="text-foreground/60 font-body text-sm lg:text-base">{category.subtitle}</p>
          </div>
        ...
        <div 
          className="flex flex-col lg:flex-row lg:overflow-y-auto flex-1 overscroll-contain scroll-smooth"
        ...
        >
            ...
            <div className="relative">
              ...
              <div className="aspect-square rounded-lg overflow-hidden bg-muted">
                ...
                {currentImages.length > 1 && (
                  <>
                    <link rel="preload" as="image" href={currentImages[(currentImageIndex + 1) % currentImages.length]} />
                    {currentImages.length > 2 && (
                      <link rel="preload" as="image" href={currentImages[(currentImageIndex + 2) % currentImages.length]} />
                    )}
                  </>
                )}
              </div>
          ...
          <div className="lg:w-1/2 p-4 lg:p-6 border-l-0 lg:border-l border-border lg:overflow-y-auto lg:max-h-[70vh]">
            <div className="space-y-4 lg:space-y-6">
              {/* Description */}
              <div>
                <h3 className="text-base lg:text-lg font-display text-foreground mb-2">Description</h3>
                <p className="text-sm lg:text-base text-foreground/80 font-body leading-relaxed">
