...
Our story began when John and Margaret Partridge recognised a need for reliable, high-quality linen services in the hospitality industry. Starting with just a handful of local restaurants, they built relationships based on trust, quality, and personalised service. Today, three generations of the Partridge family work together, combining the wisdom of experience with fresh perspectives and modern innovations.
    ...
    >
      <div className="bg-background border border-border rounded-lg max-w-4xl w-full my-8 flex flex-col max-h-[calc(100vh-4rem)]">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border flex-shrink-0">
          ...
          <Button variant="ghost" size="icon" onClick={onClose} aria-label="Close about modal">
            <X className="h-5 w-5" />
          </Button>
        </div>
